...
<div id="header">
  <div class="div1">
    <?php /*<div class="div2"><img src="view/image/logo.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>*/?>
    <?php if ($logged) { ?>
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_taoapi; ?></a>
        <ul>
