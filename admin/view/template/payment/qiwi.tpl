      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><textarea name="qiwi_bank_<?php echo $language['language_id']; ?>" cols="80" rows="10"><?php echo isset(${'qiwi_bank_' . $language['language_id']}) ? ${'qiwi_bank_' . $language['language_id']} : ''; ?></textarea>
          ...
          <tr>
            ...
            <td><input type="text" name="qiwi_total" value="<?php echo $qiwi_total; ?>" /></td>
          </tr>
          <tr>
