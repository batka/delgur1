...
class ModelSaleOrder extends Model {
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'western_union_name' => $order_query->row['western_union_name'],
				'western_union_pin'  => $order_query->row['western_union_pin']
			);
		} else {
			return false;
		}
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.western_union_name, o.western_union_pin, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
		...
		if (!empty($data['filter_western_union_pin'])) {
			$sql .= " AND o.western_union_name = '" . $data['filter_western_union_pin'] . "'";
		}
		
		if (!empty($data['filter_western_union_pin'])) {
			$sql .= " AND o.western_union_pin = '" . $data['filter_western_union_pin'] . "'";
		}
	...
	public function addTaobaoOrder($order_id, $taobao_orders) {
	
		foreach($taobao_orders as $order_product_id => $taobao_order_id)
		{
			$this->db->query("UPDATE " . DB_PREFIX . "order_product SET taobao_order = '" . $taobao_order_id 
	...
	public function getTotalOrders($data = array()) {
		...
		if (!empty($data['filter_western_union_pin'])) {
			$sql .= " AND western_union_pin = '" . $data['filter_western_union_pin'] . "'";
		}
