...
<div class="buttons_user">
  <div>
    <a href="http://magazintao.com/contact" id="forum_button" class="contact_us">
      <span>Contact</span>
    </a>
    <a class="chat" style="z-index:100" href="http://magazintao.com/live-chat" target="">
      <span>Chat</span>
    </a>
...
<div id="footer">
  <div class="column">
    ...
    <ul>      
        ...
        <li><a href="http://magazintao.com/guarantee">Гарантии</a></li>
        <li><a href="http://magazintao.com/privacy-policy">Политика безопасности</a></li>
        <li><a href="http://magazintao.com/terms-and-conditions">Условия договора</a></li>
        <li><a href="http://magazintao.com/contact-us">Контакты</a></li>
    </ul>
  </div>
  <div class="column">
