		...
		<ul class="site-nav" id="site-nav">
			...
			<li class="site-subnav site-nav-me">
				...
				<ul>
					...
					<?php /*<li><a rel="nofollow" href="http://magazintao.com/index.php?route=account/reward">Бонусные баллы</a></li>*/ ?>
			...
			<li class="site-nav-wish"> 
				<span><a rel="nofollow" href="http://magazintao.com/shipment-price" id="calculator">Расчет доставки</a></span>
			</li>
			...
			<li class="site-subnav site-nav-help"> 
				...
				<ul>
					<li><a href="http://magazintao.com/basics">Для новичков</a></li>
					<li><a href="http://magazintao.com/how-to-order">Как оформить заказ</a></li>
					<li><a href="http://magazintao.com/info-search">Поиск товара</a></li>
					<li><a href="http://magazintao.com/payment-info">Оплата</a></li>
					<li><a href="http://magazintao.com/delivery-information">Варианты доставки</a></li>
					<li><a href="http://magazintao.com/faq">Часто задаваемые вопросы</a></li>
				</ul>
			</li>
